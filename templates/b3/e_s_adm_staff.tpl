...
<div class="container-fluid">
	...
	<label id="sta_<{$t_key}>" title='<{$t_key}>_<{$staff_list}>' name_title='<{$staff_list}>' class="label label-success" style="display: none;"><{$staff_list}></label>
	<{else}>
	<label id="sta_<{$t_key}>" title='<{$t_key}>_<{$staff_list}>' name_title='<{$staff_list}>' class="label label-success"><{$staff_list}></label>
	<{/if}>
	...
	<{/foreach }>
      ...
      <div class="row">
      	<p>
            <div class="label label-info">說明</div><br/>
